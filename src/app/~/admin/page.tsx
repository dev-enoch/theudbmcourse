  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mt-4">
        ...
        <Card className="col-span-4">
          <CardHeader>
            <CardTitle>Device Claims & Piracy (30 Days)</CardTitle>
            <CardDescription>Anti-piracy locks generated by the ClaimedOrders system.</CardDescription>
          </CardHeader>
          <CardContent className="pl-2">
            <DeviceClaimsChart data={analytics.deviceClaims30Days} />
          </CardContent>
        </Card>
      </div>
